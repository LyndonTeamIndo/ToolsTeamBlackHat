...
print("\033[1;31;40m")
print("""
𝔹𝕃𝔸ℂ𝕂 ℍ𝔸𝕋 𝕋𝔼𝔸𝕄 𝔹𝕃𝔸ℂ𝕂 ℍ𝔸𝕋 𝕋𝔼𝔸𝕄 𝔹𝕃𝔸ℂ𝕂 ℍ𝔸𝕋 𝕋𝔼𝔸𝕄 𝔹𝕃𝔸ℂ𝕂 ℍ𝔸𝕋 𝕋𝔼𝔸𝕄 """)
print("\033[1;36;40m--------METHODS UDP / TCP TOOLS------")
print("-----------TOOLS FOR TEAM------------")
print("--------Subscribe Yt Lyndon Official--------")
...
def run():
	...
	while True:
		...
		try:
			...
			print("\033[1;36;40mBlack Hat Team Attack %s Port %s"%(ip,port))
